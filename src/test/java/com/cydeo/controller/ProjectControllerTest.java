...
class ProjectControllerTest {
    ...
    static UserDTO manager; // these fields are static because we will use BeforeAll method
    // BeforeAll method is static, so if we want to use field inside static method, we need to make them static
    static ProjectDTO project;

    @BeforeAll // Here we are creating sample data before start testing
    static void setUp(){
    ...
    @Test
    void givenNoToken_getProjects() throws Exception{ // this test when we don't use token
...
@Test
    void givingToken_updateProject() throws Exception{
